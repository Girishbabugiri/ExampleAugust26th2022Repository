...
public class Program1 {
	...
	private static void createuser()
	{
		try
		{
			...
			oBrowser.findElement(By.name("username")).sendKeys("Venkateshravi");
			oBrowser.findElement(By.name("password")).sendKeys("Venky@3211");
			oBrowser.findElement(By.name("passwordCopy")).sendKeys("Venky@3211");
			Thread.sleep(1000);
