...
public class Program3 {
	...
	private static void User1()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(By.name("firstName")).sendKeys("giri");
			oBrowser.findElement(By.name("middleName")).sendKeys("v");
			oBrowser.findElement(By.name("lastName")).sendKeys("Babu");
			oBrowser.findElement(By.name("email")).sendKeys("GirishGiri@gmail.com");
			oBrowser.findElement(By.name("username")).sendKeys("Giriuser1");
			oBrowser.findElement(By.name("password")).sendKeys("Giri@3211");
			oBrowser.findElement(By.name("passwordCopy")).sendKeys("Giri@3211");
			Thread.sleep(1000);
	...
	private static void User2()
	{
		try
		{
			...
			oBrowser.findElement(By.name("lastName")).sendKeys("Venkatesh");
			oBrowser.findElement(By.name("email")).sendKeys("venky@gmail.com");
			oBrowser.findElement(By.name("username")).sendKeys("venkyuser2");
	...
	private static void User3()
	{
		try
		{
			...
			oBrowser.findElement(By.name("middleName")).sendKeys("h");
			oBrowser.findElement(By.name("lastName")).sendKeys("Ravi");
			oBrowser.findElement(By.name("email")).sendKeys("ravi@gmail.com");
			oBrowser.findElement(By.name("username")).sendKeys("Raviuser3");
	...
	private static void LoginUser1()
	{
		try
		{
			oBrowser.findElement(By.id("username")).sendKeys("Giriuser1");
			oBrowser.findElement(By.name("pwd")).sendKeys("Giri@3211");
			oBrowser.findElement(By.xpath("//*[@id='loginButton']/div")).click();
			Thread.sleep(1000);
	...
	private static void LoginUser2()
	{
		try
		{
			oBrowser.findElement(By.id("username")).sendKeys("venkyuser2");
	...
	private static void LoginUser3()
	{
		try
		{
			oBrowser.findElement(By.id("username")).sendKeys("raviuser3");
	...
	private static void SecontimeLoginUser1()
	{
		...
		{
			oBrowser.findElement(By.id("username")).sendKeys("Giriuser1");
			oBrowser.findElement(By.name("pwd")).sendKeys("Giri@321");
			oBrowser.findElement(By.xpath("//*[@id='loginButton']/div")).click();
			Thread.sleep(1000);
		}catch(Exception e)
	...
	private static void Modifyuser1()
	{
		try
		{
			oBrowser.findElement(By.xpath("//*[@id='topnav']/tbody/tr[1]/td[5]/a/div[2]")).click();
			Thread.sleep(1000);
			oBrowser.findElement(By.xpath("//span[text()='Girish, Giri .']")).click();
			Thread.sleep(1000);
			oBrowser.findElement(By.name("password")).sendKeys("Giri");
			Thread.sleep(1000);
			oBrowser.findElement(By.name("passwordCopy")).sendKeys("Giri");
			Thread.sleep(1000);
